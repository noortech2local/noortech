...
(ROOT / 'collections.html').write_text(output)
print(f'Built collections.html: {len(used)} translated strings, {len(output):,} characters; English and Arabic with embedded assets.')
